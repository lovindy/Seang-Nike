...
const navDesign = () => {
  ...
  return `
      ...
      <div id="menu-list" class="bg-white text-black w-full flex justify-center duration-300 z-50 md:top-[110px] md:top[90px] h-0 absolute">
        <div id="text-hid" class="text-nowrap invisible bg-white max-w-[1850px] flex justify-between">
          <ul class="px-[80px]">
            <li><a class="font-medium text-gray-900 align-text-bottom hover:text-gray-400 cursor-pointer" href="#">AIR FORCE 1</a></li>
            <li><a class="font-medium text-gray-900 align-text-bottom hover:text-gray-400 cursor-pointer" href="#">JORDAN 1</a></li>
            <li><a class="font-medium text-gray-900 align-text-bottom hover:text-gray-400 cursor-pointer" href="#">AIR JORDAN</a></li>
            <li><a class="font-medium text-gray-900 align-text-bottom hover:text-gray-400 cursor-pointer" href="#">REACT</a></li>
            <li><a class="font-medium text-gray-900 align-text-bottom hover:text-gray-400 cursor-pointer" href="#">VAPOR MAX</a></li>
            <li><a class="font-medium text-gray-900 align-text-bottom hover:text-gray-400 cursor-pointer" href="#">ZOOM FLY</a></li>
            <li><a class="font-medium text-gray-900 align-text-bottom hover:text-gray-400 cursor-pointer" href="#">PEGASUS</a></li>
            <li><a class="font-medium text-gray-900 align-text-bottom hover:text-gray-400 cursor-pointer" href="#">ADAPT</a></li>
          </ul>
          <div class="p-6">
            <a href="#">
              <img class="flex items-center object-contain max-h-[280px]" src="https://img.freepik.com/free-photo/sport-shoes-red-pedestal_1150-21205.jpg" alt="" />
            </a>
          </div>
        </div>
      </div>
